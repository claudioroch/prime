          ...
          <div class="card shadow mb-4">
            ...
            <form class="user" method="POST" name="form_edit">
              <div class="form-group row mb-3">
                ...
                <div class="col-md-3">
                  <label>CNPJ</label>
                  <input type="text" class="form-control form-control-user cnpj" name="sistema_cnpj" placeholder="Digite o CNPJ" value="<?php echo $sistema->sistema_cnpj; ?>">
                  <?php echo form_error('sistema_cnpj', '<small class="form-text text-danger">','</small>'); ?>
                </div>
                <div class="col-md-3">
                  <label>Inscrição Estadual</label>
                  <input type="text" class="form-control form-control-user" name="sistema_ie" placeholder="Digite sua IE" value="<?php echo $sistema->sistema_ie; ?>">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="email" class="form-control form-control-user" name="sistema_email" placeholder="Digite o e-mail" value="<?php echo $sistema->sistema_email; ?>">
                  <?php echo form_error('sistema_email', '<small class="form-text text-danger">','</small>'); ?>
                </div>
                <div class="col-md-4">
                  <label>Web Site</label>
                  <input type="text" class="form-control form-control-user" name="sistema_site_url" placeholder="Digite seu Web Site" value="<?php echo $sistema->sistema_site_url; ?>">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-md-2">
                  <label>Número</label>
                  <input type="text" class="form-control form-control-user" name="sistema_numero" placeholder="Digite o número" value="<?php echo $sistema->sistema_numero; ?>">
                ...
                <div class="col-md-2">
                  <label>Cidade</label>
                  <input type="text" class="form-control form-control-user" name="sistema_cidade" placeholder="Digite sua cidade" value="<?php echo $sistema->sistema_cidade; ?>">
                  <?php echo form_error('sistema_cidade', '<small class="form-text text-danger">','</small>'); ?>
                </div>
                <div class="col-md-2">
                  <label>Estado</label>
                  <input type="text" class="form-control form-control-user uf" name="sistema_estado" placeholder="Digite seu estado" value="<?php echo $sistema->sistema_estado; ?>">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label>Texto</label>
                  <textarea class="form-control form-control-user" name="sistema_txt_ordem_servico" placeholder="Texto"><?php echo $sistema->sistema_txt_ordem_servico; ?></textarea>
