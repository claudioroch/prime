        ...
        <?php endif;?>  
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a title="Cadastrar novo cliente" href="<?php echo base_url('clientes/add') ?> " class="btn btn-sm btn-success float-right"><i class="fas fa-plus"></i>&nbsp;Novo</a> 
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                  ...
                  <?php foreach ($clientes as $cliente):?>
                    <tr>
                      ...
                      <td class="text-right">
                        <a title="Editar" href="<?php echo base_url('clientes/edit/'.$cliente->cliente_id) ?>" title="Editar" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                        <a title="Deletar" href="javascript(void)"  data-toggle="modal" data-target="#cliente-<?php echo $cliente->cliente_id; ?>" title="Excluir" class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                      </td>
                    </tr>
                      <!-- Logout Modal-->
