        ...
        <nav aria-label="breadcrumb">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a title="Voltar" href="<?php echo base_url('usuarios'); ?>" class="btn btn-sm btn-success float-right"><i class="fas fa-arrow-left"></i></i>&nbsp;Voltar</a> 
            </div>
            <div class="card-body">
            <form class="user" method="POST" name="form_edit">
              ...
              <button type="submit" class="btn btn-primary btn-sm">Salvar</button><br>
