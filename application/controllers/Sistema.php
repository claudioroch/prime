...
class Sistema extends CI_Controller{
    ...
    public function index(){
        ...
        $this->form_validation->set_rules('sistema_txt_ordem_servico', 'Texto ordem de serviço e venda', 'max_length[500]');
        //$this->form_validation->set_rules('sistema_data_alteracao', '', '');
